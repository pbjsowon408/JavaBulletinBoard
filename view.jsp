        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a
              ...
              aria-haspopup="true"
              aria-expanded="false"
              >Members Manage<span class="caret"></span
            ></a>
            <ul class="dropdown-menu">
      ...
      <div class="row">
          ...
          >
            ...
            <tbody>
			  ...
			  <tr>
                <td>Written Date</td>
                <td colspan="2"><%= bbs.getBbsDate().substring(0,11) + bbs.getBbsDate().substring(11, 13) + "Hours" + bbs.getBbsDate().substring(14,16) + "Minutes" %></td>
              </tr>
			  <tr>
                <td>Content</td>
          ...
          <a href="bbs.jsp" class="btn btn-primary">Content</a>
          <% 
